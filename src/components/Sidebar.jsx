...
const Socials = [
  {
    icon: <FaGithub className="h-6 w-6 text-slate-400" />,
    path: "https://github.com/mista4chun",
  },
  {
...
function Sidebar() {
  return (
    <div className="flex w-12 flex-col items-center justify-between border py-2">
